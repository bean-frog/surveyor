  ...
  return (
    <div className="flex flex-col items-center min-h-screen justify-between w-full">
      <div className="flex flex-col items-center justify-center w-full flex-grow">
        <div className="w-3/5 h-fit p-6 pb-2 rounded-lg flex flex-col items-center justify-center border-2 border-solid border-ctp-overlay2">
      ...
      <footer className="flex flex-row items-center justify-center space-x-2 mb-4">
        <a
          ...
          className="text-ctp-lavender inter-regular text-lg underline"
        >
          Source code
        </a>
        <Link
