  ...
  return (
    <div className="mb-6 p-4 bg-ctp-surface1 shadow-md rounded-lg">
      ...
      <div className="flex justify-between">
        {[1, 2, 3, 4, 5].map((value) => (
          <label key={value} className="flex items-center gap-2 cursor-pointer hover:text-ctp-lavender">
            <input
              type="radio"
              name={`q${id}`}
              value={value}
    ...
    <div className="mb-6 p-4 bg-ctp-surface1 shadow-md rounded-lg">
      ...
      <div className="flex gap-6">
        {[
          ...
          <label key={label} className="flex items-center gap-2 cursor-pointer hover:text-ctp-lavender">
            <input
              type="radio"
              name={`q${id}`}
              value={value}
...
function Survey() {
  ...
  if (loading) {
    return <div className="flex justify-center items-center">Loading questions...</div>;
  }
